# Leo Web — Architecture & Feature Specification

*Canonical architecture for this repository — v1.1*
...
| [`ARCHITECTURE.md`](./ARCHITECTURE.md) | This file — scope, routes, phases, checklist |
...
*Update this file when BD7/BD7a scope or phase gates change. Do not duplicate it in `leo-api` — link here instead.*